...
HD_PWD='C:/Users/b00128907/Desktop/practical_1/practical_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log harrys_comb_logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source harrys_comb_logic.tcl
