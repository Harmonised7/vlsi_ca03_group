...
--D CLOCK_IN RESET_IN Q Qbar
begin
flip0:vi_d_flip_flop_rise port map (sQ0bar, CLOCK_IN, sRESET, sQ0, sQ0bar);
flip1:vi_d_flip_flop_rise port map (sQ1bar, sQ0bar, sRESET, sQ1, sQ1bar);
flip2:vi_d_flip_flop_rise port map (sQ2bar, sQ1bar, sRESET, sQ2, sQ2bar);

sRESET <= RESET_IN or (not sQ0 and sQ1 and sQ2);
